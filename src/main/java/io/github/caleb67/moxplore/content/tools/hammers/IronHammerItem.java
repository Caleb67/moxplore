...
public class IronHammerItem extends PickaxeItem {
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        // usage tooltip
        tooltip.add(Text.translatable("item.moxplore.iron_hammer.tooltip").formatted(Formatting.AQUA));
    }


    public IronHammerItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
