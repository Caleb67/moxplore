package io.github.caleb67.moxplore.content.items;
...
public class WaterOrb extends Item {
    ...
    public WaterOrb(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        // usage tooltip
        tooltip.add(Text.translatable("item.moxplore.water_filter.tooltip").formatted(Formatting.AQUA));
    }



    // give water breathing on use
    @Override
